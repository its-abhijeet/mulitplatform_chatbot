...
class EmailMessage(models.Model):
    message = models.OneToOneField(Message, on_delete=models.CASCADE, related_name='email_details')
    batch = models.ForeignKey(EmailBatch, on_delete=models.SET_NULL, null=True, related_name='emails')
...
class EmailClick(models.Model):
    email = models.ForeignKey(EmailMessage, on_delete=models.CASCADE, related_name='click_events')
    url = models.URLField()
